...
<body>
<form id="form8" name="form8" method="post" action="../../forgetController">
    ...
    <table width="35%" height="383" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <td>
          ...
          <!-- <input name="sex" type="checkbox" class="text_style" id="textfield4" size="35" /> -->
          <select name="sex">
